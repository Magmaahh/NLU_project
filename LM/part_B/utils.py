...
class Lang():
    ...
    # Create word2id dictionary with special tokens first
...
class PennTreeBank (data.Dataset):
    ...
    # Return a sample as a dictionary of input/target tensors
    ...
    # Map sequences of tokens to corresponding IDs using Lang class
