...
This folder contains the code I wrote to complete Part 1.A of
...
## Code usage
The code implements a configurable RNN/LSTM-based language model for next-word prediction using the Penn Treebank (PTB) dataset.
